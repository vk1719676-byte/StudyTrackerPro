      ...
      <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-r ${currentBannerData.gradient} transition-all duration-1000`}>
        ...
        <div className="relative z-10 p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            <div className="flex items-center gap-3 sm:gap-4 text-white flex-1 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs sm:text-sm text-white/90 font-medium line-clamp-2 sm:truncate">
