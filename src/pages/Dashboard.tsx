...
import { TeachersDayBanner } from '../components/banner/TeachersDay';
...
const StatCard: React.FC<{
  ...
  <ModernCard hover className="p-4 sm:p-6 h-full">
    <div className="flex items-start justify-between mb-3 sm:mb-4">
      <div className={`p-3 sm:p-4 ${bgGradient} rounded-2xl shadow-lg group-hover:scale-110 transition-all duration-500`}>
        <Icon className={`w-5 h-5 sm:w-6 sm:h-6 ${color} drop-shadow-sm`} />
      </div>
      {change && (
        <div className={`flex items-center gap-1.5 px-2 py-1 sm:px-3 sm:py-1.5 rounded-xl text-xs sm:text-sm font-bold ${
    ...
    <div className="space-y-2">
      <p className="text-xs sm:text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">{label}</p>
      <p className="text-xl sm:text-2xl md:text-3xl font-black text-gray-900 dark:text-gray-100">{value}</p>
    </div>
  </ModernCard>
);
  ...
  <ModernCard hover className="p-4 sm:p-6 h-full">
    <div className="flex justify-between items-start mb-4">
      <div className="flex items-start gap-3 sm:gap-4 flex-1 min-w-0">
        <div className="p-2 sm:p-3 bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900/30 dark:to-purple-900/30 rounded-2xl shadow-md group-hover:scale-110 transition-all duration-300">
          <BookOpen className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-600 dark:text-indigo-400" />
        </div>
        <div className="min-w-0 flex-1">
          <h3 className="font-bold text-gray-900 dark:text-gray-100 text-base sm:text-lg truncate mb-1">
            {session.subject}
          </h3>
      ...
      <div className="text-right flex-shrink-0 ml-3 sm:ml-4">
        <div className="text-lg sm:text-xl font-black text-gray-900 dark:text-gray-100 bg-gray-100 dark:bg-gray-700 px-2 py-1 sm:px-3 sm:py-1.5 rounded-xl">
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700">
        ...
        {exam && (
          <div className="bg-gray-100 dark:bg-gray-700 px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs text-gray-600 dark:text-gray-300 truncate max-w-20 sm:max-w-24">
            {exam.name}
          </div>
        )}
      </div>
...
export const Dashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-indigo-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
      ...
      {/* Teacher's Day Banner - Added at the top */}
      <div className="pt-16 sm:pt-20 md:pt-8">
        <TeachersDayBanner />
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 md:pb-12">
        
        {/* Modern Hero Section - Enhanced for mobile */}
        <div className="mb-8 sm:mb-10">
          <div className={`relative overflow-hidden bg-gradient-to-br ${currentThemeData.gradient} rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 text-white shadow-2xl`}>
            {/* Animated background elements */}
            <div className="absolute inset-0 opacity-10">
              <div className="absolute top-1/4 left-1/4 w-24 h-24 sm:w-32 sm:h-32 bg-white rounded-full blur-3xl animate-pulse"></div>
              <div className="absolute bottom-1/4 right-1/4 w-16 h-16 sm:w-24 sm:h-24 bg-white rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}}></div>
            </div>
            ...
            <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div className="flex-1">
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm font-semibold">
                  <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-xl sm:rounded-2xl px-3 py-2 sm:px-4 sm:py-2">
                    <Calendar className="w-3 h-3 sm:w-4 sm:h-4" />
                  ...
                  <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-xl sm:rounded-2xl px-3 py-2 sm:px-4 sm:py-2">
                    ...
                    <span>L{Math.floor(sessions.length / 10) + 1}</span>
                  </div>
                </div>
              </div>
              
              <div className="flex-shrink-0">
                <div className={`p-4 sm:p-6 bg-gradient-to-br ${currentThemeData.accent} rounded-2xl sm:rounded-3xl shadow-2xl backdrop-blur-sm`}>
                  <ThemeIcon className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white drop-shadow-lg" />
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Modern Stats Grid - Enhanced for mobile */}
        ...
        {/* Analytics and Deadlines - Enhanced mobile layout */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-10">
          
          {/* Performance Analytics */}
          <div className="lg:col-span-2">
            <ModernCard className="p-6 sm:p-8 h-full">
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6 sm:mb-8">
                ...
                <div className="bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 px-3 py-2 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-bold w-fit">
                  Real-time Data
                </div>
              </div>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-blue-200/50 dark:border-blue-700/50">
                  <div className="flex items-center gap-3 mb-4">
                    <Activity className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 dark:text-blue-400" />
                    <span className="font-bold text-gray-700 dark:text-gray-300 text-sm sm:text-base">Weekly Progress</span>
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Study Time</span>
                      <span className="text-xs sm:text-sm font-bold text-emerald-700 bg-emerald-100 dark:text-emerald-400 dark:bg-emerald-900/30 px-2 py-1 sm:px-3 sm:py-1 rounded-full">
                        +{performanceMetrics.timeChange}%
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Sessions</span>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-purple-200/50 dark:border-purple-700/50">
                  <div className="flex items-center gap-3 mb-4">
                    <Timer className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600 dark:text-purple-400" />
                    <span className="font-bold text-gray-700 dark:text-gray-300 text-sm sm:text-base">Session Insights</span>
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Avg. Duration</span>
                      <span className="text-xs sm:text-sm font-bold text-gray-900 dark:text-gray-100">
                        {formatMinutes(performanceMetrics.averageSessionLength)}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Best Time</span>
                      <span className="text-xs sm:text-sm font-bold text-gray-900 dark:text-gray-100">
                        10:00 AM
                      </span>
                    </div>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-orange-200/50 dark:border-orange-700/50">
                <div className="flex items-center justify-between mb-4 sm:mb-6">
                  <div className="flex items-center gap-3">
                    <Flame className="w-4 h-4 sm:w-5 sm:h-5 text-orange-600 dark:text-orange-400" />
                    <span className="font-bold text-gray-700 dark:text-gray-300 text-sm sm:text-base">Study Streak</span>
                  </div>
                ...
                <div className="flex gap-1 sm:gap-2 mb-3">
                  {[...Array(14)].map((_, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        className={`h-3 sm:h-4 flex-1 rounded-lg transition-all duration-300 ${
                          hasStudied 
          ...
          {/* Enhanced Upcoming Deadlines - Mobile optimized */}
          <div>
            <ModernCard className="p-0 h-full overflow-hidden">
              {/* Enhanced Header */}
              <div className="relative bg-gradient-to-br from-red-600 via-pink-600 to-rose-700 p-4 sm:p-6">
                <div className="absolute inset-0 bg-black/10"></div>
                <div className="absolute top-4 right-4 w-16 h-16 sm:w-24 sm:h-24 bg-white/10 rounded-full blur-2xl"></div>
                <div className="absolute bottom-2 left-6 w-12 h-12 sm:w-16 sm:h-16 bg-white/5 rounded-full blur-xl"></div>
                ...
                <div className="relative flex items-center justify-between">
                  <div className="flex items-center gap-3 sm:gap-4">
                    <div className="p-3 sm:p-4 bg-white/20 backdrop-blur-lg rounded-2xl sm:rounded-3xl shadow-xl border border-white/30">
                      <AlertCircle className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white drop-shadow-lg" />
                    </div>
                    <div>
                      <h2 className="text-xl sm:text-2xl font-black text-white mb-1 drop-shadow-sm">Deadlines</h2>
                      <p className="text-white/80 font-medium text-xs sm:text-sm">Upcoming this week</p>
                    </div>
                  </div>
                  
                  {upcomingDeadlines.length > 0 && (
                    <div className="flex items-center gap-2 bg-white/20 backdrop-blur-lg rounded-xl sm:rounded-2xl px-3 py-2 sm:px-4 sm:py-2 border border-white/30">
                      <div className="w-2 h-2 bg-red-300 rounded-full animate-pulse"></div>
                      <span className="text-white font-bold text-xs sm:text-sm">{upcomingDeadlines.length} urgent</span>
                    </div>
                  )}
                </div>
              </div>
                ...
                {upcomingDeadlines.length > 0 ? (
                  <div className="space-y-4">
                    {upcomingDeadlines.slice(0, 4).map((exam, index) => {
                      ...
                      return (
                        <div 
                          key={exam.id} 
                          className="group relative overflow-hidden rounded-xl sm:rounded-2xl transition-all duration-500 hover:scale-[1.02] hover:shadow-xl"
                          style={{ animationDelay: `${index * 100}ms` }}
                        >
                          {/* Deadline Card */}
                          <div className={`relative p-4 sm:p-5 border-2 transition-all duration-300 ${
                            isToday 
                            ...
                            } rounded-t-xl sm:rounded-t-2xl`}></div>

                            <div className="flex items-start justify-between mb-4">
                              <div className="min-w-0 flex-1">
                                <div className="flex items-center gap-2 sm:gap-3 mb-2">
                                  <h3 className="font-black text-gray-900 dark:text-gray-100 text-lg sm:text-xl truncate">
                                    {exam.name}
                                  </h3>
                                  {isToday && (
                                    <div className="flex items-center gap-1 bg-red-500 text-white px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs font-bold animate-pulse">
                                ...
                                <div className="flex items-center gap-3">
                                  <div className={`flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2 rounded-xl font-bold text-xs sm:text-sm ${
                                    isToday 
                              ...
                              <div className="text-right flex-shrink-0 ml-3 sm:ml-4">
                                ...
                                <div className={`text-xs font-bold px-2 py-1 sm:px-3 sm:py-1 rounded-full ${
                            ...
                            <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-gray-200/50 dark:border-gray-700/50">
                              <button className={`w-full flex items-center justify-center gap-2 px-3 py-2 sm:px-4 sm:py-3 rounded-xl font-bold text-xs sm:text-sm transition-all duration-300 hover:scale-105 hover:shadow-lg ${
                                isUrgent 
                    ...
                    {upcomingDeadlines.length > 4 && (
                      <div className="text-center pt-4">
                        <button className="inline-flex items-center gap-2 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 font-bold bg-red-50 dark:bg-red-900/30 px-4 py-2 sm:px-6 sm:py-3 rounded-xl sm:rounded-2xl hover:bg-red-100 dark:hover:bg-red-900/50 transition-all duration-300 group text-sm sm:text-base">
                          View All Deadlines
                  ...
                  <div className="text-center py-8 sm:py-12">
                    <div className="relative mb-4 sm:mb-6">
                      <div className="p-6 sm:p-8 bg-gradient-to-br from-emerald-100 via-green-100 to-teal-100 dark:from-emerald-900/30 dark:via-green-900/30 dark:to-teal-900/30 rounded-full mb-4 inline-block shadow-xl">
                        <CheckCircle2 className="w-12 h-12 sm:w-16 sm:h-16 text-emerald-600 dark:text-emerald-400 mx-auto" />
                      </div>
                      <div className="absolute -top-2 -right-2 w-5 h-5 sm:w-6 sm:h-6 bg-yellow-400 rounded-full animate-bounce">
                        ✨
                      </div>
                    </div>
                    <h3 className="font-black text-gray-900 dark:text-gray-100 text-xl sm:text-2xl mb-3">
                      All Clear!
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6 px-4">
                      No deadlines this week.<br />
                      Perfect time to get ahead! 🚀
                    </p>
                    <button className="inline-flex items-center gap-3 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-bold px-4 py-3 sm:px-6 sm:py-3 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group text-sm sm:text-base">
        ...
        {/* Main Action Cards - Enhanced mobile spacing */}
        ...
        {/* Recent Sessions - Enhanced mobile layout */}
        {sessions.length > 0 && (
          <div className="space-y-6 sm:space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div>
                  <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100">Recent Sessions</h2>
                  <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base">Your latest study activities</p>
                </div>
              </div>
              <button className="flex items-center gap-2 text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 font-bold bg-indigo-50 dark:bg-indigo-900/30 px-4 py-2 sm:px-6 sm:py-3 rounded-xl sm:rounded-2xl hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition-all duration-300 group text-sm sm:text-base">
                View All Sessions
            ...
            {sessions.length > 6 && (
              <div className="text-center">
                <button className="inline-flex items-center gap-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold px-6 py-3 sm:px-8 sm:py-4 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group text-sm sm:text-base">
                  <Plus className="w-4 h-4 sm:w-5 sm:h-5" />
                  Load More Sessions
