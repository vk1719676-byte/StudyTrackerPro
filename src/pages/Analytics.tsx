...
import { TrendingUp, Target, Clock, Star, Brain, Zap, Crown, Award, BookOpen, ArrowUp, ArrowDown, Activity } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20 md:pb-8 pt-4 md:pt-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Discover insights, track progress, and compete with other learners in our community
          </p>
        </div>

        {/* Tab selector for Analytics/Leaderboard */}
