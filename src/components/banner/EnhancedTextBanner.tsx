  ...
  return (
    <div className="mb-6 relative">
      ...
      >
        ...
        {/* Content Container */}
        <div className={`flex items-center justify-between py-4 px-6 ${currentNoticeData.textColor} transition-all duration-300 ${isAnimating ? 'opacity-0 translate-y-2' : 'opacity-100 translate-y-0'}`}>
          ...
          <div className="flex items-center gap-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium truncate pr-4 group-hover:text-opacity-90 transition-colors duration-200">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            >
              <span className="hidden sm:inline">{currentNoticeData.action}</span>
            ...
            <button
              ...
              className="p-2 hover:bg-black/10 dark:hover:bg-white/10 rounded-lg transition-all duration-200 hover:scale-110 opacity-60 hover:opacity-100"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
      ...
      <div className="mt-3 flex items-center justify-center gap-2 text-xs text-gray-500 dark:text-gray-400">
        ...
        <span>Stay connected • Updates every 5 seconds</span>
      </div>
